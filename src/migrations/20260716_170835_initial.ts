...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_pages_editor_mode" AS ENUM('richtext', 'builder');
  CREATE TYPE "public"."enum_pages_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__pages_v_version_editor_mode" AS ENUM('richtext', 'builder');
  CREATE TYPE "public"."enum__pages_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum_site_settings_theme" AS ENUM('folyoirat', 'studio', 'magazin');
  CREATE TYPE "public"."enum_navigation_header_link_type" AS ENUM('page', 'custom');
  CREATE TYPE "public"."enum_navigation_footer_link_type" AS ENUM('page', 'custom');
  ...
  CREATE TABLE "pages" (
  	...
  	"layout" jsonb,
  	"slug" varchar,
  	"editor_mode" "enum_pages_editor_mode" DEFAULT 'richtext',
  	"seo_meta_title" varchar,
  	"seo_meta_description" varchar,
  	"seo_og_image_id" integer,
  	"seo_canonical_url" varchar,
  ...
  CREATE TABLE "_pages_v" (
  	...
  	"version_slug" varchar,
  	"version_editor_mode" "enum__pages_v_version_editor_mode" DEFAULT 'richtext',
  	"version_seo_meta_title" varchar,
  	"version_seo_meta_description" varchar,
  	"version_seo_og_image_id" integer,
  	"version_seo_canonical_url" varchar,
  ...
  CREATE TABLE "site_settings" (
  	...
  	"tagline" varchar,
  	"logo_id" integer,
  	"theme" "enum_site_settings_theme" DEFAULT 'folyoirat' NOT NULL,
  	"footer_text" varchar,
  	"gtm_id" varchar,
  ...
  CREATE TABLE "navigation_header" (
  	...
  	"link_type" "enum_navigation_header_link_type" DEFAULT 'page',
  	"page_id" integer,
  	"url" varchar,
  ...
  CREATE TABLE "navigation_footer" (
  	...
  	"id" varchar PRIMARY KEY NOT NULL,
  	"label" varchar NOT NULL,
  	"link_type" "enum_navigation_footer_link_type" DEFAULT 'page',
  	"page_id" integer,
  	"url" varchar,
  	"new_tab" boolean DEFAULT false
  );
  ...
  ALTER TABLE "navigation_footer" ADD CONSTRAINT "navigation_footer_page_id_pages_id_fk" FOREIGN KEY ("page_id") REFERENCES "public"."pages"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "navigation_footer_page_idx" ON "navigation_footer" USING btree ("page_id");`)
}
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_pages_editor_mode";
  DROP TYPE "public"."enum_pages_status";
  DROP TYPE "public"."enum__pages_v_version_editor_mode";
  DROP TYPE "public"."enum__pages_v_version_status";
  DROP TYPE "public"."enum_site_settings_theme";
  DROP TYPE "public"."enum_navigation_header_link_type";
  DROP TYPE "public"."enum_navigation_footer_link_type";`)
}
